...
#ifndef __STM32L433_H__
#define __STM32L433_H__

#include <arch/stm32l4xx.h>

#ifndef __ASSEMBLER__

#define STM32_PWR    ((struct stm32_pwr *)STM32_BASE_PWR)
#define STM32_RCC    ((struct stm32_rcc *)STM32_BASE_RCC)
#define STM32F_RTC   ((struct stm32f_rtc *)STM32_BASE_RTC)
#define STM32F_USB   ((struct stm32f_usb *)STM32_BASE_USB)
#define STM32_FLASH  ((struct stm32_flash *)STM32_BASE_FLASH)
#define STM32F_FSMC  ((struct stm32f_fsmc *)STM32_BASE_FSMC)
#define STM32F_DAC1  ((struct stm32f_dac *)STM32_BASE_DAC1)
...
#define STM32F_SPI1  ((struct stm32f_spi *)STM32_BASE_SPI1)
#define STM32F_SPI2  ((struct stm32f_spi *)STM32_BASE_SPI2)
#define STM32F_SPI3  ((struct stm32f_spi *)STM32_BASE_SPI3)

#define STM32F_I2C1 ((struct stm32f_i2c *)STM32_BASE_I2C1)
#define STM32F_I2C2 ((struct stm32f_i2c *)STM32_BASE_I2C2)

#define STM32F_DMA1  ((struct stm32f_dma *)STM32_BASE_DMA1)
#define STM32F_DMA2  ((struct stm32f_dma *)STM32_BASE_DMA2)

#define STM32F_TIM1  ((struct stm32f_tim *)STM32_BASE_TIM1)
#define STM32F_TIM2  ((struct stm32f_tim *)STM32_BASE_TIM2)
#define STM32F_TIM3  ((struct stm32f_tim *)STM32_BASE_TIM3)
#define STM32F_TIM4  ((struct stm32f_tim *)STM32_BASE_TIM4)

#define STM32F_TIM6  ((struct stm32f_tim *)STM32_BASE_TIM6)
#define STM32F_TIM7  ((struct stm32f_tim *)STM32_BASE_TIM7)
#define STM32F_TIM8  ((struct stm32f_tim *)STM32_BASE_TIM8)
#define STM32F_TIM15 ((struct stm32f_tim *)STM32_BASE_TIM15)
#define STM32F_TIM16 ((struct stm32f_tim *)STM32_BASE_TIM16)
#define STM32F_TIM17 ((struct stm32f_tim *)STM32_BASE_TIM17)
