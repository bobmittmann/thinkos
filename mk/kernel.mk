...
ifeq ($(HOST),Cygwin)
  ...
  ifdef PROG_KRN
    PROG_KRN_WIN := $(subst \,\\,$(shell cygpath -w $(PROG_KRN)))
  endif
  ifdef PROG_LST
...
PFILES := $(PROG_KRN) $(PROG_SREC) $(PROG_LST) \
		  $(PROG_SYM) $(PROG_MAP)
...
all: $(LIBDIRS_ALL) $(PROG_KRN) $(PROG_SYM) $(PROG_LST)
...
$(PROG_KRN) $(PROG_MAP): $(LIBDIRS_ALL) $(OFILES) $(OBJ_EXTRA)
	$(ACTION) "LD: $(PROG_KRN)"
ifdef $(CROSS_COMPILE))
ifeq ($(HOST),Cygwin)
