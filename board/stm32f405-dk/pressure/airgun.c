...
void freq_gen_init(uint32_t freq)
{
	...
	/* USART1_TX */
	stm32_gpio_mode(TIM4_CH3, ALT_FUNC, PUSH_PULL | SPEED_LOW);
	stm32_gpio_mode(TIM4_CH4, ALT_FUNC, PUSH_PULL | SPEED_LOW);
	stm32_gpio_af(TIM4_CH3, GPIO_AF2);
	stm32_gpio_af(TIM4_CH4, GPIO_AF2);
