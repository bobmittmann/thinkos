...
const char zarathustra_0[] = {
	"http://www.gutenberg.org/catalog/world<br>\n<br>\n"
	"Thus Spake Zarathustra by Friedrich Wilhelm Nietzsche<br>\n<br>\n"
	"Nietzsche Archives,<br>\n"
	"Weimar, December 1905.<br>\n<br>\n<br>\n<br>\n"
	"THUS SPAKE ZARATHUSTRA.<br>\n"
	"FIRST PART.<br>\n"
	"ZARATHUSTRA'S DISCOURSES.<br>\n"
	"ZARATHUSTRA'S PROLOGUE.<br>\n<br>\n"
};
...
const char zarathustra_2[] = {
	...
	"Zarathustra he was called; but he hath altered.<br>\n"
	"Then thou carriedst thine ashes into the mountains:  wilt thou now carry "
	"thy fire into the valleys?  Fearest thou not the incendiary's doom?<br>\n"
	"Yea, I recognise Zarathustra.  Pure is his eye, and no loathing lurketh "
	"about his mouth.  Goeth he not along like a dancer?<br>\n"
	"Altered is Zarathustra; a child hath Zarathustra become; "
	"an awakened one is "
	"Zarathustra:  what wilt thou do in the land of the sleepers?<br>\n"
	...
	"believe that we come with gifts.<br>\n"
	...
	"sunrise, so they ask themselves concerning us:  Where goeth the thief?<br>\n"
	"Go not to men, but stay in the forest!  "
	"Go rather to the animals!  Why not "
	"be like me--a bear amongst bears, a bird amongst birds?\"<br>\n"
	"\"And what doeth the saint in the forest?\" asked Zarathustra.<br>\n"
	"The saint answered:  \"I make hymns and sing them; and in making hymns "
	"I laugh and weep and mumble:  thus do I praise God.<br>\n"
	"With singing, weeping, laughing, "
	"and mumbling do I praise the God who is my "
	"God.  But what dost thou bring us as a gift?\"<br>\n"
	...
	"and Zarathustra, laughing like schoolboys.<br>\n"
...
const char zarathustra_3[] = {
	...
	"have ye done to surpass man?<br>\n"
	...
	"same shall man be to the Superman:  a laughing-stock, a thing of shame.<br>\n"
	...
	"phantom.  But do I bid you become phantoms or plants?<br>\n"
	"Lo, I teach you the Superman!<br>\n"
	"The Superman is the meaning of the earth.  "
	"Let your will say:  The Superman "
	"SHALL BE the meaning of the earth!<br>\n"
	...
	"whom the earth is weary:  so away with them!<br>\n"
	...
	"Thus it thought to escape from the body and the earth.<br>\n"
	"Oh, that soul was itself meagre, ghastly, and "
	"famished; and cruelty was the "
	"delight of that soul!<br>\n"
	...
	"you, and so also your reason and virtue.<br>\n"
	...
	"thought the words applied to him, began his performance.<br>\n<br>\n"
};

const char zarathustra_4[] = {
	"4.<br>\n<br>\n"
		"Zarathustra, however, looked at the people and wondered.  Then he spake<br>\nthus:<br>\n"
		...
		"dangerous trembling and halting.<br>\n"
		"What is great in man is that he is a bridge and not a goal:  what is "
		"lovable in man is that he is an OVER-GOING and a DOWN-GOING.<br>\n"
		...
		"of longing for the other shore.<br>\n"
		...
		"of the Superman may hereafter arrive.<br>\n"
		"I love him who liveth in order to know, and seeketh to know in order that "
		"the Superman may hereafter live.  Thus seeketh he his own down-going.<br>\n"
		...
		"the sake of his virtue, he is willing to live on, or live no more.<br>\n"
...
const char zarathustra_5[] = {
	"5.<br>\n<br>\n"
		...
		"they understand me not; I am not the mouth for these ears.<br>\n"
		...
		"they only believe the stammerer?<br>\n"
		...
		"longer despise himself.<br>\n"
		"Lo!  I show you THE LAST MAN.<br>\n"
		"\"What is love?  What is creation?  What is longing?  What is a star?\"--so "
		"asketh the last man and blinketh.<br>\n"
		...
		"ground-flea; the last man liveth longest.<br>\n"
		"\"We have discovered happiness\"--say the last men, and blink thereby.<br>\n"
		...
		"it spoileth their stomachs.<br>\n"
		"They have their little pleasures for the day, and their little pleasures "
		"for the night, but they have a regard for health.<br>\n"
		"\"We have discovered happiness,\"--say the last men, and blink thereby.--<br>\n"
		...
		"Zarathustra, however, turned sad, and said to his heart:<br>\n"
		"\"They understand me not:  I am not the mouth for these ears.<br>\n"
		"Too long, perhaps, have I lived in the mountains; too much have I hearkened "
		"unto the brooks and trees:  now do I speak unto them as unto the goatherds.<br>\n"
		"Calm is my soul, and clear, like the mountains in the morning.  But they "
		"think me cold, and a mocker with terrible jests.<br>\n"
		"And now do they look at me and laugh:  and while they laugh they hate me "
		"too.  There is ice in their laughter.\"<br>\n<br>\n"
};
...
const char zarathustra_6[] = {
	"6.<br>\n<br>\n"
		...
		"be dead even sooner than thy body:  fear, therefore, nothing any more!\"<br>\n"
		...
		"hath been taught to dance by blows and scanty fare.\"<br>\n"
		...
		"therefore will I bury thee with mine own hands.\"<br>\n"
		"When Zarathustra had said this the dying one did not reply further; but he "
		"moved his hand as if he sought the hand of Zarathustra in gratitude.<br>\n<br>\n"
};
...
const char zarathustra_7[] = {
	"7.<br>\n<br>\n"
		...
		"he hath caught, but a corpse.<br>\n"
		...
		"the lightning out of the dark cloud--man.<br>\n"
		"But still am I far from them, and my sense speaketh not unto their sense.  "
		"To men I am still something between a fool and a corpse.<br>\n"
...
const char zarathustra_8[] = {
	"8.<br>\n<br>\n"
		...
		"themselves, and put their heads together.<br>\n"
		...
		"at a lonely house in which a light was burning.<br>\n"
		"\"Hunger attacketh me,\" said Zarathustra, \"like a robber.  Among forests and "
		"swamps my hunger attacketh me, and late in the night.<br>\n"
		"\"Strange humours hath my hunger.  Often it cometh to me only after a "
		"repast, and all day it hath failed to come:  where hath it been?\"<br>\n"
		...
		"refresheth his own soul, saith wisdom.\"<br>\n"
		...
		"knocketh at my door must take what I offer him.  Eat, and fare ye well!\"--<br>\n"
...
const char zarathustra_9[] = {
	"9.<br>\n<br>\n"
		...
		"spake thus to his heart:<br>\n"
		"A light hath dawned upon me:  I need companions--living ones; not "
		"dead companions and corpses, which I carry with me where I will.<br>\n"
		"But I need living companions, who will follow me because they want "
		"to follow themselves--and to the place where I will.<br>\n"
		"A light hath dawned upon me.  Not to the people is Zarathustra to speak, "
		"but to companions!  Zarathustra shall not be the herd's herdsman and hound!<br>\n"
		...
		"say, but they call themselves the believers in the orthodox belief.<br>\n"
		...
		"plucketh the ears of corn and is vexed.<br>\n"
		...
		"But they are the reapers and rejoicers.<br>\n"
		...
		"thy hollow tree; well have I hid thee from the wolves.<br>\n"
		"But I part from thee; the time hath arrived.  'Twixt rosy dawn and rosy "
		"dawn there came unto me a new truth.<br>\n"
		...
		"rainbow will I show them, and all the stairs to the Superman.<br>\n"
...
const char zarathustra_10[] = {
	"10.<br>\n<br>\n"
		...
		"itself coiled round the eagle's neck.<br>\n"
		"\"They are mine animals,\" said Zarathustra, and rejoiced in his heart.<br>\n"
		"\"The proudest animal under the sun, and the wisest animal under the sun,-- "
		"they have come out to reconnoitre.<br>\n"
		...
		"paths goeth Zarathustra.  Let mine animals lead me!<br>\n"
		"When Zarathustra had said this, he remembered the words of the saint in the "
		"forest.  Then he sighed and spake thus to his heart:<br>\n"
		...
		"-may my pride then fly with my folly!\"<br>\n"
		"Thus began Zarathustra's down-going.<br>\n<br>\n"
};

const char const * zarathustra_txt[] = {
	zarathustra_0,
	zarathustra_1,
	zarathustra_2,
	zarathustra_3,
...
const uint16_t zarathustra_len[] = {
	sizeof(zarathustra_0),
	sizeof(zarathustra_1),
	sizeof(zarathustra_2),
	sizeof(zarathustra_3),
	sizeof(zarathustra_4),
	sizeof(zarathustra_5),
	sizeof(zarathustra_6),
	sizeof(zarathustra_7),
	sizeof(zarathustra_8),
	sizeof(zarathustra_9),
	sizeof(zarathustra_10)
};
