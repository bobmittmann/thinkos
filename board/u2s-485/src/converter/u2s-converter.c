...
const struct thinkos_thread_initializer led_thread_init = {
	.stack_base = (uintptr_t)led_stack,
	.stack_size = sizeof(led_stack),
	.task_entry = (uintptr_t)led_task,
...
const struct thinkos_thread_initializer ctrl_thread_init = {
	.stack_base = (uintptr_t)serial_ctrl_stack,
	.stack_size = sizeof(serial_ctrl_stack),
	.task_entry = (uintptr_t)serial_ctrl_task,
	.task_exit = (uintptr_t)NULL,
	.task_arg[0] = (uintptr_t)&vcom,
	.task_arg[1] = 0,
	.task_arg[2] = 0,
	.task_arg[3] = 0,
	.priority = 2,
...
const struct thinkos_thread_initializer recv_thread_init = {
	.stack_base = (uintptr_t)serial_recv_stack,
	.stack_size = sizeof(serial_recv_stack),
	.task_entry = (uintptr_t)serial_recv_task,
	.task_exit = (uintptr_t)NULL,
	.task_arg[0] = (uintptr_t)&vcom,
	.task_arg[1] = 0,
	.task_arg[2] = 0,
