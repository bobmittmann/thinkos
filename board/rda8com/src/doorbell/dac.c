...
int16_t dac_silence[DAC_FRAME_SIZE] = { 0, }; 
...
uint32_t dac_stack[512] __attribute__ ((aligned(8)));
...
struct mp3_stream mp3_instance;

int dac_mp3_play(const uint8_t data[], unsigned int len)
{
	struct mp3_stream * mp3 = &mp3_instance;
