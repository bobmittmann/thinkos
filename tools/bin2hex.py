...
def bin2hex(f, name, attr, data, size):
  f.write('/*---------------------------------------------------------------------------\n')
  ...
  if attr is not None:
    f.write('__attribute__((' + attr + ')) '); 
  f.write(name + '[{:d}]'.format(size) + ' = {' + '\n')
...
if __name__ == '__main__':
  ...
  parser.add_option("-a", "--attribute", dest="attribute", 
					help="add extra attribute to the C array", metavar="ATTRIBUTE")
...
#  	data = gzip.compress(data);
  ...
  size = len(data);
  bin2hex(fout, name, attribute, data, size)
