...
int console_comm_send(void * dev, const void * buf, unsigned int len) 
{
...
int console_comm_recv(void * dev, void * buf, 
...
struct comm_dev console_comm_dev = {
	.arg = NULL,
	.op = {
		.send = console_comm_send,
		.recv = console_comm_recv
	}
};
