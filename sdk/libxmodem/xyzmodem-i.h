#ifndef __XYZMODEM_I_H__
#define __XYZMODEM_I_H__
...
#define ZMAXHLEN    16		/* maximum header information length */
#define ZMAXSPLEN	1024	/* maximum subpacket length */
...
#define Z_MAX_SUBPKT_LEN ZMODEM_PKT_LEN_MAX


char * __zm_ch(int ch);
char * __zm_frm(int frame);
