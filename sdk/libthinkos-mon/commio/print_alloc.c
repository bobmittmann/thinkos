...
void monitor_print_alloc(const struct monitor_comm * comm)
{
	...
	monitor_printf(comm, "   Thread");
#endif
#if THINKOS_ENABLE_MUTEX_ALLOC
	monitor_printf(comm, "    Mutex");
#endif
#if THINKOS_ENABLE_COND_ALLOC
	monitor_printf(comm, "     Cond");
#endif
#if THINKOS_ENABLE_SEM_ALLOC
	monitor_printf(comm, "  Semaphr");
#endif
#if THINKOS_ENABLE_EVENT_ALLOC
	monitor_printf(comm, "    Event");
#endif
#if THINKOS_ENABLE_FLAG_ALLOC
	monitor_printf(comm, "     Flag");
#endif
	monitor_printf(comm, "\r\n");

	monitor_printf(comm, " Cnt:");
#if THINKOS_ENABLE_THREAD_ALLOC
	monitor_printf(comm, "%6d/%-2d", 
